...
function randomize_buttons(clicked_button_id){
    ...
    get('score').innerHTML = parseInt(get('score').innerHTML)
      + (i.lastIndexOf('+', 0) === 0 ? parseInt(get('green-points').value) : -parseInt(get('red-points').value));
    ...
    if(p){
        ...
        if(get('green-frequency').value > 0){
            i = get('green-frequency').value > (grid_side * grid_side) - 1
        ...
        if(get('green-frequency').value == 0 || (get('grid-dimensions').value > 1 && (grid_side * grid_side) - ti > 0)){
            ...
            i = get('red-frequency').value > (grid_side * grid_side) - ti - 1
